...
![The Bringup welcome screen on first launch, with the Next button](../assets/screenshots/welcome-screen.webp)
...
![The Setup step, showing System Service Required and the Install button](../assets/screenshots/daemon-setup.webp)
...
![The Bringup workbench, showing the Devices view with an empty fleet](../assets/screenshots/workbench.webp)
