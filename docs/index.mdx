...
Capability arrives through extensions. Eleven are available today: Fleet Manager, Organization Manager, Shell Access, File Browser, Telemetry, Visualizer, Zenoh Bridge, Image Deploy, Yocto Builder, Rollouts, and Bag Master — the extension for recording, managing, and analyzing ROS bags. See [Extensions](/extensions/) for the full list.
